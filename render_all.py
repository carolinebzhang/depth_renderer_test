...
# this is the main function to render rgb and depth images for one object from multiple viewpoints
...
def get_3x4_RT_matrix_from_blender(cam):
    ...
    location, rotation = cam.matrix_world.decompose()[0:2] # check matrix with custom conversion code
...
if __name__ == '__main__':
    ...
    for model in result_list:
        ...
        rendering_dir = osp.join(output_folder, model.path.split('/')[-3])
        # print(f'Rendering directory : {rendering_dir}')
        print('Rendering directory : {}'.format(rendering_dir))
